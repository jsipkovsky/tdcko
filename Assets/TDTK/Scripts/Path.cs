...
namespace TDTK{
	...
	public class Path : MonoBehaviour {
		...
		public bool IsConnWP(int idx) 
		{
			var a = waypointTList[idx];
			return true;
		}
		...
		*/
		...
		public List<int> connectorPoints = new();    //all the full path, constructed in runtime
		public List<int> nextPathP = new();
